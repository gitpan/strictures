# This Makefile is for the strictures extension to perl.
#
...
#     NAME => q[strictures]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/strictures.pm]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/matthewt/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/matthewt/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.56
MM_REVISION = 65600
...
TO_INST_PM = lib/strictures.pm

PM_TO_BLIB = lib/strictures.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/strictures.pm $(INST_MAN3DIR)/strictures.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               strictures' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            1.002000' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.002000">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/strictures.pm blib/lib/strictures.pm 
